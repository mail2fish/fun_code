...
export default [
    ...
    route("/", "routes/with_auth.tsx", [
        ...
        route("/www/user/lesson/:lessonId/resources", "routes/user/lesson_resources.tsx"),
        ...
        route("/www/user/programs/:programId/histories", "routes/program_histories.tsx"),
