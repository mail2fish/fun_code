...
type ClassCourse struct {
	ClassID     uint   `json:"class_id" gorm:"not null;uniqueIndex:idx_class_course"`  // 班级ID
	CourseID    uint   `json:"course_id" gorm:"not null;uniqueIndex:idx_class_course"` // 课程ID
